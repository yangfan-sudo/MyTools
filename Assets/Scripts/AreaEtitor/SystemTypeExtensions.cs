...
public static class TypeExtensions
{
    ...
    {
        return type.GetField(name, BindAll);
    }
    ...
    public static FieldInfo[] GetFieldsAll(this Type type)
    {
        return type.GetFields(BindAll);
    }

    public static PropertyInfo[] GetPropertiesAll(this Type type)
    {
        return type.GetProperties(BindAll);
    }
